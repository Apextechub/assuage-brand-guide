...
const description =
  "Careers at Assuage Attorneys: current vacancies and graduate opportunities at a commercial law firm in Lagos, Nigeria.";
  ...
  return (
    <>
      <PageHeader
        label="Careers"
        title="Work with us"
        intro="We hire carefully and train deliberately. If you value precise work and plain dealing, we would like to hear from you."
      />
              ...
              >
                ...
                <div className="flex flex-col items-start gap-4 md:col-span-4 md:col-start-9 md:pt-1">
                  <p className="micro-label text-ink-soft">
                    Closing · <time dateTime={role.closingDate}>{formatNewsDate(role.closingDate)}</time>
                  </p>
                  <a
                    href="#apply"
      ...
      {/* Application form */}
      <section id="apply" className="border-t border-rule bg-mist py-16 md:py-24" aria-labelledby="apply-heading">
